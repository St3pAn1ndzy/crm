...
class LeadsCreateView(PermissionRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        logger.info(
            "Кэш статистики рекламы автоматически сброшен из-за добавления нового лида."
        )
...
class LeadsUpdateView(PermissionRequiredMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        cache.delete("crm_ads_statistic_list")
        logger.info(
            "Кэш статистики рекламы автоматически сброшен из-за обновления лида."
        )
...
class LeadsDeleteView(PermissionRequiredMixin, DeleteView):
    ...
    def form_valid(self, form):
        ...
        cache.delete("crm_ads_statistic_list")
        logger.info("Кэш статистики рекламы автоматически сброшен из-за удаления лида.")
